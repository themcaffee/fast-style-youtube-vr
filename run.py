...
def main(argv):
    ...
    parser.add_argument("--model", help="Model name to stylize as")
    parser.add_argument("--start-time", help="[hh:mm:ss] The time to start at in the video. Default is 00:00:00.", default="00:00:00")
    ...
    parser.add_argument("--duration", help="Length of video to process in seconds. Default is 10 seconds.", type=int, default=10)
    parser.add_argument("--dry-run", help="If true, skip running the styling script for testing the rest of the steps", default="false")
